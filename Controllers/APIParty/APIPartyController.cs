...
namespace PartyProductAPI.Controllers.APIParty
{
    [Route("api/[controller]/[action]")]
    [ApiController]
    public class APIPartyController : ControllerBase
    {
        private readonly IPartyRepository _partyRepository;

        public APIPartyController(IPartyRepository partyRepository)
        {
